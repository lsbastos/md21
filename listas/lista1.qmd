...
3.  Seja a seguinte função de densidade e probabilidade: $$f_X(x) = \left\{ \begin{array}{lc} cx^2, & -1 < x < 1, \\ 0, & c.c..\end{array}\right.$$ onde $c$ é uma constante.
...
5.  Sejam $X$ e $Y$ duas variáveis aleatórias independentes com distribuição uniforme no intervalo $(0,a)$. Encontre $f_Z(z)$ quando
...
6.  Suponha que $X|Y \sim Poisson(Y)$ e $Y \sim Gamma(a,b)$.
